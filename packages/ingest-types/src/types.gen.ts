 ...
 */
export type SubscriptionTier = 'FREE' | 'STANDARD' | 'CREATOR' | 'PRO' | 'FOUNDERS_EDITION';
 ...
 */
export type BillingStatus = 'awaiting_payment_method' | 'pending_payment' | 'paid' | 'payment_failed' | 'inactive';
...
export type VerifyWorkspaceApiKeyError = VerifyWorkspaceApiKeyErrors[keyof VerifyWorkspaceApiKeyErrors];
...
export type VerifyWorkspaceApiKeyResponse = VerifyWorkspaceApiKeyResponses[keyof VerifyWorkspaceApiKeyResponses];
...
export type SetReviewStatusResponse2 = SetReviewStatusResponses[keyof SetReviewStatusResponses];
...
export type UpdateHubWorkflowError = UpdateHubWorkflowErrors[keyof UpdateHubWorkflowErrors];
...
export type UpdateHubWorkflowResponse = UpdateHubWorkflowResponses[keyof UpdateHubWorkflowResponses];
...
export type GetDeletionRequestError = GetDeletionRequestErrors[keyof GetDeletionRequestErrors];
...
export type GetDeletionRequestResponse = GetDeletionRequestResponses[keyof GetDeletionRequestResponses];
...
export type CreateDeletionRequestError = CreateDeletionRequestErrors[keyof CreateDeletionRequestErrors];
...
export type CreateDeletionRequestResponse = CreateDeletionRequestResponses[keyof CreateDeletionRequestResponses];
...
export type ReportPartnerUsageError = ReportPartnerUsageErrors[keyof ReportPartnerUsageErrors];
...
export type ReportPartnerUsageResponse = ReportPartnerUsageResponses[keyof ReportPartnerUsageResponses];
...
export type UpdateSubscriptionCacheError = UpdateSubscriptionCacheErrors[keyof UpdateSubscriptionCacheErrors];
...
export type UpdateSubscriptionCacheResponse = UpdateSubscriptionCacheResponses[keyof UpdateSubscriptionCacheResponses];
...
export type ListLinkedFirebaseUidsError = ListLinkedFirebaseUidsErrors[keyof ListLinkedFirebaseUidsErrors];
...
export type ListLinkedFirebaseUidsResponse2 = ListLinkedFirebaseUidsResponses[keyof ListLinkedFirebaseUidsResponses];
...
export type EnsureWorkspaceBillingProvisionedError = EnsureWorkspaceBillingProvisionedErrors[keyof EnsureWorkspaceBillingProvisionedErrors];
...
export type EnsureWorkspaceBillingProvisionedResponse2 = EnsureWorkspaceBillingProvisionedResponses[keyof EnsureWorkspaceBillingProvisionedResponses];
...
export type InsertDynamicConfigError = InsertDynamicConfigErrors[keyof InsertDynamicConfigErrors];
...
export type InsertDynamicConfigResponse = InsertDynamicConfigResponses[keyof InsertDynamicConfigResponses];
